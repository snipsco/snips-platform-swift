Pod::Spec.new do |s|
  ...
  s.summary = 'The Objective-C framework for the Snips Platform'
  s.description = <<-DESC
  ...
  s.source_files  = 'SnipsPlatformObjC/*.{swift}', 'SnipsPlatform/*.{swift}'
  ...
  s.pod_target_xcconfig = {
    'ENABLE_BITCODE' => 'NO',
    'SWIFT_INCLUDE_PATHS' => '"${SRCROOT}/SnipsPlatformObjC/Dependencies/ios"',
    'LIBRARY_SEARCH_PATHS' => '"${SRCROOT}/SnipsPlatformObjC/Dependencies/ios"',
    'VALID_ARCHS' => 'arm64',
  }
